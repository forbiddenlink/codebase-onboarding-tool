...
CREATE TABLE "FileNode" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "FileNode_repositoryId_fkey" FOREIGN KEY ("repositoryId") REFERENCES "Repository" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Dependency" (
    ...
    "lineNumber" INTEGER,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "Dependency_fromFileId_fkey" FOREIGN KEY ("fromFileId") REFERENCES "FileNode" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "Dependency_toFileId_fkey" FOREIGN KEY ("toFileId") REFERENCES "FileNode" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "FunctionNode" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "FunctionNode_fileId_fkey" FOREIGN KEY ("fileId") REFERENCES "FileNode" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Annotation" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "Annotation_fileId_fkey" FOREIGN KEY ("fileId") REFERENCES "FileNode" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE "ChatMessage" (
    ...
    "sources" TEXT,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "ChatMessage_repositoryId_fkey" FOREIGN KEY ("repositoryId") REFERENCES "Repository" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE "LearningPath" (
    ...
    CONSTRAINT "LearningPath_repositoryId_fkey" FOREIGN KEY ("repositoryId") REFERENCES "Repository" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
